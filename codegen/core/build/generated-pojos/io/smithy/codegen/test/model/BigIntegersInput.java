...
@SmithyGenerated
public final class BigIntegersInput implements SerializableShape {
    ...
    static final class InnerSerializer implements BiConsumer<BigIntegersInput, ShapeSerializer> {
        static final InnerSerializer INSTANCE = new InnerSerializer();

        @Override
        public void accept(BigIntegersInput shape, ShapeSerializer serializer) {
            serializer.writeBigInteger(SCHEMA_REQUIRED_BIG_INTEGER, shape.requiredBigInteger);
            if (shape.optionalBigInteger != null) {
                serializer.writeBigInteger(SCHEMA_OPTIONAL_BIG_INTEGER, shape.optionalBigInteger);
            }
            serializer.writeBigInteger(SCHEMA_DEFAULT_BIG_INTEGER, shape.defaultBigInteger);
        }
    }
    ...
    public static final class Builder implements SdkShapeBuilder<BigIntegersInput> {
        ...
        public Builder defaultBigInteger(BigInteger defaultBigInteger) {
            this.defaultBigInteger = defaultBigInteger;
            return this;
        }
