...
@SmithyGenerated
public final class BigDecimalsInput implements SerializableShape {
    ...
    static final class InnerSerializer implements BiConsumer<BigDecimalsInput, ShapeSerializer> {
        static final InnerSerializer INSTANCE = new InnerSerializer();

        @Override
        public void accept(BigDecimalsInput shape, ShapeSerializer serializer) {
            serializer.writeBigDecimal(SCHEMA_REQUIRED_BIG_DECIMAL, shape.requiredBigDecimal);
            if (shape.optionalBigDecimal != null) {
                serializer.writeBigDecimal(SCHEMA_OPTIONAL_BIG_DECIMAL, shape.optionalBigDecimal);
            }
            serializer.writeBigDecimal(SCHEMA_DEFAULT_BIG_DECIMAL, shape.defaultBigDecimal);
        }
    }
