...
@SmithyGenerated
public final class StructuresInput implements SerializableShape {
    ...
    static final class InnerSerializer implements BiConsumer<StructuresInput, ShapeSerializer> {
        static final InnerSerializer INSTANCE = new InnerSerializer();

        @Override
        public void accept(StructuresInput shape, ShapeSerializer serializer) {
            serializer.writeStruct(SCHEMA_REQUIRED_STRUCT, shape.requiredStruct, Nested.InnerSerializer.INSTANCE);
            if (shape.optionalStruct != null) {
                serializer.writeStruct(SCHEMA_OPTIONAL_STRUCT, shape.optionalStruct, Nested.InnerSerializer.INSTANCE);
            }
        }
    }
