...
@SmithyGenerated
public final class BigDecimalMembersInput implements SerializableStruct {
    public static final ShapeId ID = ShapeId.from("smithy.java.codegen.test.structures#BigDecimalMembersInput");

    static final Schema SCHEMA = Schema.structureBuilder(ID)
        .putMember("requiredBigDecimal", PreludeSchemas.BIG_DECIMAL,
            new RequiredTrait())
        .putMember("optionalBigDecimal", PreludeSchemas.BIG_DECIMAL)
        .putMember("defaultBigDecimal", PreludeSchemas.BIG_DECIMAL,
            new DefaultTrait(Node.from(1.0)))
        .build();

    private static final Schema SCHEMA_REQUIRED_BIG_DECIMAL = SCHEMA.member("requiredBigDecimal");
    private static final Schema SCHEMA_OPTIONAL_BIG_DECIMAL = SCHEMA.member("optionalBigDecimal");
    private static final Schema SCHEMA_DEFAULT_BIG_DECIMAL = SCHEMA.member("defaultBigDecimal");
    ...
    private BigDecimalMembersInput(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        BigDecimalMembersInput that = (BigDecimalMembersInput) other;
        return Objects.equals(this.requiredBigDecimal, that.requiredBigDecimal)
               && Objects.equals(this.optionalBigDecimal, that.optionalBigDecimal)
               && Objects.equals(this.defaultBigDecimal, that.defaultBigDecimal);
    }
    ...
    /**
     * Builder for {@link BigDecimalMembersInput}.
     */
    public static final class Builder implements ShapeBuilder<BigDecimalMembersInput> {
        ...
        @Override
        public BigDecimalMembersInput build() {
            tracker.validate();
            return new BigDecimalMembersInput(this);
        }

        @Override
        public ShapeBuilder<BigDecimalMembersInput> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
