...
@SmithyGenerated
public final class ExceptionWithExtraStringException extends ModeledApiException {
    ...
    private static final Schema SCHEMA_EXTRA = Schema.memberBuilder("extra", PreludeSchemas.STRING)
        .id(ID)
        .build();
     ...
     */
    public static final class Builder implements ShapeBuilder<ExceptionWithExtraStringException> {
        ...
        @Override
        public ShapeBuilder<ExceptionWithExtraStringException> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
