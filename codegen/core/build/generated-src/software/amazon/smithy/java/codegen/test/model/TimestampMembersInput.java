...
public final class TimestampMembersInput implements SerializableStruct {
    ...
    private static final Schema SCHEMA_REQUIRED_TIMESTAMP = Schema.memberBuilder("requiredTimestamp", PreludeSchemas.TIMESTAMP)
        .id(ID)
        .traits(
            new RequiredTrait()
        )
    ...
    private static final Schema SCHEMA_OPTIONAL_TIMESTAMP = Schema.memberBuilder("optionalTimestamp", PreludeSchemas.TIMESTAMP)
        .id(ID)
        .build();

    private static final Schema SCHEMA_DEFAULT_TIMESTAMP = Schema.memberBuilder("defaultTimestamp", PreludeSchemas.TIMESTAMP)
        .id(ID)
        .traits(
