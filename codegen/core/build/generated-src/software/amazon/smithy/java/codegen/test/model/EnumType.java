...
public final class EnumType implements SerializableShape {
    public static final ShapeId ID = ShapeId.from("smithy.java.codegen.test.structures#EnumType");
    ...
    static final Schema SCHEMA = Schema.createEnum(ID,
        Set.of(OPTION_ONE.value,OPTION_TWO.value)
    );
     ...
     */
    public static final class Builder implements ShapeBuilder<EnumType> {
