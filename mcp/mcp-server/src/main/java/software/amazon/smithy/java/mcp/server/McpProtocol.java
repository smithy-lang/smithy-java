...
public sealed interface McpProtocol permits BuiltInProtocol, ExtensionMcpProtocol {
    ...
    /**
     * Preference used when an initialize request names an unsupported or stateless
     * protocol. Higher values are preferred.
     *
     * <p>Only initialization-capable, stateful protocols participate.
     */
    default int initializationPriority() {
        return 0;
    }
    ...
    default Document decorateResult(
        ...
        return decorateResult(result, method, serverIdentity);
    }
