...
public final class NamingInput implements SerializableStruct {
    ...
    private static final Schema SCHEMA_OTHER = Schema.memberBuilder("other", PreludeSchemas.STRING)
        .id(ID)
        .build();

    private static final Schema SCHEMA_BUILDER_MEMBER = Schema.memberBuilder("builder", BuilderShape.SCHEMA)
        .id(ID)
        .build();

    private static final Schema SCHEMA_INNER = Schema.memberBuilder("inner", InnerDeserializerShape.SCHEMA)
        .id(ID)
        .build();

    private static final Schema SCHEMA_TYPE_MEMBER = Schema.memberBuilder("type", TypeShape.SCHEMA)
        .id(ID)
        .build();
