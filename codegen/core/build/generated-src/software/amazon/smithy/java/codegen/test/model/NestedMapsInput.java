...
public final class NestedMapsInput implements SerializableStruct {
    ...
    private static final Schema SCHEMA_MAP_OF_STRING_MAP = Schema.memberBuilder("mapOfStringMap", SharedSchemas.MAP_OF_STRING_MAP)
        .id(ID)
        .build();

    private static final Schema SCHEMA_MAP_OF_MAP_OF_STRING_MAP = Schema.memberBuilder("mapOfMapOfStringMap", SharedSchemas.MAP_OF_MAP_OF_STRING_MAP)
        .id(ID)
        .build();

    private static final Schema SCHEMA_MAP_OF_STRING_LIST = Schema.memberBuilder("mapOfStringList", SharedSchemas.MAP_OF_STRING_LIST)
        .id(ID)
        .build();

    private static final Schema SCHEMA_MAP_OF_MAP_LIST = Schema.memberBuilder("mapOfMapList", SharedSchemas.MAP_OF_MAP_LIST)
        .id(ID)
        .build();
