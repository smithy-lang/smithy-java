...
public final class ShortMembersInput implements SerializableStruct {
    ...
    private static final Schema SCHEMA_REQUIRED_SHORT = Schema.memberBuilder("requiredShort", PreludeSchemas.SHORT)
        .id(ID)
        .traits(
            new RequiredTrait()
        )
    ...
    private static final Schema SCHEMA_OPTIONAL_SHORT = Schema.memberBuilder("optionalShort", PreludeSchemas.SHORT)
        .id(ID)
        .build();

    private static final Schema SCHEMA_DEFAULT_SHORT = Schema.memberBuilder("defaultShort", PreludeSchemas.SHORT)
        .id(ID)
        .traits(
