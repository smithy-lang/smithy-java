...
public final class MapAllTypesInput implements SerializableStruct {
    ...
    static final Schema SCHEMA = Schema.structureBuilder(ID)
        .putMember("stringBooleanMap", SharedSchemas.STRING_BOOLEAN_MAP)
        .putMember("stringBigDecimalMap", SharedSchemas.STRING_BIG_DECIMAL_MAP)
        .putMember("stringBigIntegerMap", SharedSchemas.STRING_BIG_INTEGER_MAP)
        .putMember("stringByteMap", SharedSchemas.STRING_BYTE_MAP)
        .putMember("stringDoubleMap", SharedSchemas.STRING_DOUBLE_MAP)
        .putMember("stringFloatMap", SharedSchemas.STRING_FLOAT_MAP)
        .putMember("stringIntegerMap", SharedSchemas.STRING_INTEGER_MAP)
        .putMember("stringLongMap", SharedSchemas.STRING_LONG_MAP)
        .putMember("stringShortMap", SharedSchemas.STRING_SHORT_MAP)
        .putMember("stringStringMap", SharedSchemas.STRING_STRING_MAP)
        .putMember("stringBlobMap", SharedSchemas.STRING_BLOB_MAP)
        .putMember("stringTimestampMap", SharedSchemas.STRING_TIMESTAMP_MAP)
        .putMember("stringUnionMap", SharedSchemas.STRING_UNION_MAP)
        .putMember("stringEnumMap", SharedSchemas.STRING_ENUM_MAP)
        .putMember("stringIntEnumMap", SharedSchemas.STRING_INT_ENUM_MAP)
        .putMember("stringStructMap", SharedSchemas.STRING_STRUCT_MAP)
        .build();
