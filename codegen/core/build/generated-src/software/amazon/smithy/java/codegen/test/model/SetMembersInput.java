...
public final class SetMembersInput implements SerializableStruct {
    ...
    static final Schema SCHEMA = Schema.structureBuilder(ID)
        .putMember("requiredList", SharedSchemas.SET_OF_STRINGS,
            new RequiredTrait())
        .putMember("listWithDefault", SharedSchemas.SET_OF_STRINGS,
            new DefaultTrait(ArrayNode.builder()
                .build()))
        .putMember("optionalList", SharedSchemas.SET_OF_STRINGS)
        .build();
