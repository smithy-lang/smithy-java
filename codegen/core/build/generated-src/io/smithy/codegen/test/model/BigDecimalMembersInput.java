...
public final class BigDecimalMembersInput implements SerializableStruct {
    ...
    private static final Schema SCHEMA_REQUIRED_BIG_DECIMAL = Schema.memberBuilder("requiredBigDecimal", PreludeSchemas.BIG_DECIMAL)
        .id(ID)
        .traits(
            new RequiredTrait()
        )
    ...
    private static final Schema SCHEMA_OPTIONAL_BIG_DECIMAL = Schema.memberBuilder("optionalBigDecimal", PreludeSchemas.BIG_DECIMAL)
        .id(ID)
        .build();

    private static final Schema SCHEMA_DEFAULT_BIG_DECIMAL = Schema.memberBuilder("defaultBigDecimal", PreludeSchemas.BIG_DECIMAL)
        .id(ID)
        .traits(
