...
public final class NestedStruct implements SerializableStruct {
    ...
    private static final Schema SCHEMA_FIELD_A = Schema.memberBuilder("fieldA", PreludeSchemas.STRING)
        .id(ID)
        .build();

    private static final Schema SCHEMA_FIELD_B = Schema.memberBuilder("fieldB", PreludeSchemas.INTEGER)
        .id(ID)
        .build();
