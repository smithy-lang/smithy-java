...
public final class BigIntegerMembersInput implements SerializableStruct {
    ...
    private static final Schema SCHEMA_REQUIRED_BIG_INTEGER = Schema.memberBuilder("requiredBigInteger", PreludeSchemas.BIG_INTEGER)
        .id(ID)
        .traits(
            new RequiredTrait()
        )
    ...
    private static final Schema SCHEMA_OPTIONAL_BIG_INTEGER = Schema.memberBuilder("optionalBigInteger", PreludeSchemas.BIG_INTEGER)
        .id(ID)
        .build();

    private static final Schema SCHEMA_DEFAULT_BIG_INTEGER = Schema.memberBuilder("defaultBigInteger", PreludeSchemas.BIG_INTEGER)
        .id(ID)
        .traits(
