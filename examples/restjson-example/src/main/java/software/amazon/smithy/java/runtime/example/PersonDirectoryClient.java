...
public final class PersonDirectoryClient extends Client<PersonDirectoryClient> implements PersonDirectory {
    ...
    public static final class Builder extends Client.Builder<PersonDirectoryClient> {
