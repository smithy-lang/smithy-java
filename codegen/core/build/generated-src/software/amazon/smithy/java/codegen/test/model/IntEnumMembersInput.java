...
public final class IntEnumMembersInput implements SerializableStruct {
    ...
    private static final Schema SCHEMA_REQUIRED_ENUM = Schema.memberBuilder("requiredEnum", IntEnumType.SCHEMA)
        .id(ID)
        .traits(
            new RequiredTrait()
        )
    ...
    private static final Schema SCHEMA_DEFAULT_ENUM = Schema.memberBuilder("defaultEnum", IntEnumType.SCHEMA)
        .id(ID)
        .traits(
    ...
    private static final Schema SCHEMA_OPTIONAL_ENUM = Schema.memberBuilder("optionalEnum", IntEnumType.SCHEMA)
        .id(ID)
        .build();
