...
public final class Nested implements SerializableShape {
    ...
    private static final class InnerSerializer implements BiConsumer<Nested, ShapeSerializer> {
        private static final InnerSerializer INSTANCE = new InnerSerializer();

        @Override
        public void accept(Nested shape, ShapeSerializer serializer) {
            if (shape.fieldA != null) {
                serializer.writeString(SCHEMA_FIELD_A, shape.fieldA);
            }
            if (shape.fieldB != null) {
                serializer.writeInteger(SCHEMA_FIELD_B, shape.fieldB);
            }
        }
    }
