...
public abstract class CodecBench {
    ...
    protected byte[] reversedBytes;
    protected Supplier<ShapeBuilder<?>> builderSupplier;

    protected abstract Codec createCodec();

    /**
     * Reverses the top-level field order of serialized bytes.
     * Subclasses override for format-specific reversal.
     */
    ...
    public void setup() {
        ...
        reversedBytes = reverseFieldOrder(serializedBytes);
    }
