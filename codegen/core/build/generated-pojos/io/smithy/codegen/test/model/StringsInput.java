...
@SmithyGenerated
public final class StringsInput implements SerializableShape {
    ...
    static final class InnerSerializer implements BiConsumer<StringsInput, ShapeSerializer> {
        static final InnerSerializer INSTANCE = new InnerSerializer();

        @Override
        public void accept(StringsInput shape, ShapeSerializer serializer) {
            serializer.writeString(SCHEMA_REQUIRED_STRING, shape.requiredString);
            serializer.writeString(SCHEMA_DEFAULT_STRING, shape.defaultString);
            if (shape.optionalString != null) {
                serializer.writeString(SCHEMA_OPTIONAL_STRING, shape.optionalString);
            }
        }
    }
