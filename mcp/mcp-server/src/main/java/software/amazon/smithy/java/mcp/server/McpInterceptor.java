 ...
 * To reject a call with a client-visible JSON-RPC error, throw an
 * {@link McpProtocolException}. Other runtime exceptions are logged and returned
 * to the client as a sanitized {@code -32603 Internal error}.
 */
@SmithyUnstableApi
