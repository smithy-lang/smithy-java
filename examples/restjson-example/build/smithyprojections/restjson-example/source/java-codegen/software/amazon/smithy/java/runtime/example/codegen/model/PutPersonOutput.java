...
public final class PutPersonOutput implements SerializableShape {
    ...
    public static final class Builder implements SdkShapeBuilder<PutPersonOutput> {
        ...
        public Builder list(List<String> list) {
            clearList();this.list.get().addAll(list);
            return this;
        }
        ...
        public Builder addList(String value) {list.get().add(value);
            return this;
        }
        ...
        public Builder set(SequencedSet<String> set) {
            clearSet();
            createSetIfNotExists();
            this.set.addAll(set);
            return this;
        }
        ...
        public Builder addSet(String value) {
            createSetIfNotExists();
            set.add(value);
            return this;
        }

        public Builder removeSet(String value) {
            if (this.set != null) {
                set.remove(value);
            }
            return this;
        ...
        private void createSetIfNotExists() {
            if (set == null) {
