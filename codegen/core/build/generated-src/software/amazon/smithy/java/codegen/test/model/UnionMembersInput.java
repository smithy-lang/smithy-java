...
public final class UnionMembersInput implements SerializableStruct {
    ...
    private static final Schema SCHEMA_REQUIRED_UNION = Schema.memberBuilder("requiredUnion", NestedUnion.SCHEMA)
        .id(ID)
        .traits(
            new RequiredTrait()
        )
    ...
    private static final Schema SCHEMA_OPTIONAL_UNION = Schema.memberBuilder("optionalUnion", NestedUnion.SCHEMA)
        .id(ID)
        .build();
