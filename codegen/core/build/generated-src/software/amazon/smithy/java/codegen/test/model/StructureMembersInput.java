...
public final class StructureMembersInput implements SerializableStruct {
    ...
    static final Schema SCHEMA = Schema.structureBuilder(ID)
        .putMember("requiredStruct", NestedStruct.SCHEMA,
            new RequiredTrait())
        .putMember("optionalStruct", NestedStruct.SCHEMA)
        .build();

    private static final Schema SCHEMA_REQUIRED_STRUCT = SCHEMA.member("requiredStruct");
    private static final Schema SCHEMA_OPTIONAL_STRUCT = SCHEMA.member("optionalStruct");
