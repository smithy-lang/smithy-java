...
dependencies {
    ...
    runtimeOnly("io.netty:netty-tcnative-boringssl-static:2.0.84.Final:osx-aarch_64")
    runtimeOnly("io.netty:netty-tcnative-boringssl-static:2.0.84.Final:osx-x86_64")
    runtimeOnly("io.netty:netty-tcnative-boringssl-static:2.0.84.Final:linux-x86_64")
    runtimeOnly("io.netty:netty-tcnative-boringssl-static:2.0.84.Final:linux-aarch_64")
