...
public final class SparseListsInput implements SerializableStruct {
    ...
    static final Schema SCHEMA = Schema.structureBuilder(ID)
        .putMember("listOfBooleans", SharedSchemas.SPARSE_BOOLEANS)
        .putMember("listOfBigDecimal", SharedSchemas.SPARSE_BIG_DECIMALS)
        .putMember("listOfBigInteger", SharedSchemas.SPARSE_BIG_INTEGERS)
        .putMember("listOfByte", SharedSchemas.SPARSE_BYTES)
        .putMember("listOfDouble", SharedSchemas.SPARSE_DOUBLES)
        .putMember("listOfFloat", SharedSchemas.SPARSE_FLOATS)
        .putMember("listOfInteger", SharedSchemas.SPARSE_INTEGERS)
        .putMember("listOfLong", SharedSchemas.SPARSE_LONGS)
        .putMember("listOfShort", SharedSchemas.SPARSE_SHORTS)
        .putMember("listOfString", SharedSchemas.SPARSE_STRINGS)
        .putMember("listOfBlobs", SharedSchemas.SPARSE_BLOBS)
        .putMember("listOfTimestamps", SharedSchemas.SPARSE_TIMESTAMPS)
        .putMember("listOfUnion", SharedSchemas.SPARSE_UNIONS)
        .putMember("listOfEnum", SharedSchemas.SPARSE_ENUMS)
        .putMember("listOfIntEnum", SharedSchemas.SPARSE_INT_ENUMS)
        .putMember("listOfStruct", SharedSchemas.SPARSE_STRUCTS)
        .putMember("listOfDocuments", SharedSchemas.SPARSE_DOCS)
        .build();

    private static final Schema SCHEMA_LIST_OF_BOOLEANS = SCHEMA.member("listOfBooleans");
