 ...
 * <p>Listeners receive connection references for identification and metadata access only. Do NOT:
 * <ul>
 *   <li>Call {@link HttpConnection#close()} - the pool manages connection lifecycle</li>
 *   <li>Call {@link HttpConnection#newExchange} - connections may be in use or pooled</li>
 *   <li>Hold strong references to connections - this prevents garbage collection and leak detection</li>
 * </ul>
 *
 ...
 * }</pre>
 *
 * @see HttpConnectionPool.Builder#addListener(ConnectionPoolListener)
 */
