...
public final class ListMembersInput implements SerializableStruct {
    ...
    private static final Schema SCHEMA_REQUIRED_LIST = Schema.memberBuilder("requiredList", SharedSchemas.LIST_OF_STRINGS)
        .id(ID)
        .traits(
            new RequiredTrait()
        )
    ...
    private static final Schema SCHEMA_LIST_WITH_DEFAULT = Schema.memberBuilder("listWithDefault", SharedSchemas.LIST_OF_STRINGS)
        .id(ID)
        .traits(
    ...
    private static final Schema SCHEMA_OPTIONAL_LIST = Schema.memberBuilder("optionalList", SharedSchemas.LIST_OF_STRINGS)
        .id(ID)
        .build();
