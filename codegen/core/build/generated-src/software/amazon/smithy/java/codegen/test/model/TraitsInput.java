...
public final class TraitsInput implements SerializableStruct {
    ...
    private static final Schema SCHEMA_STRING_DEFAULT = Schema.memberBuilder("stringDefault", PreludeSchemas.STRING)
        .id(ID)
        .traits(
    ...
    private static final Schema SCHEMA_STRING_WITH_LENGTH = Schema.memberBuilder("stringWithLength", PreludeSchemas.STRING)
        .id(ID)
        .traits(
    ...
    private static final Schema SCHEMA_NUMBER_WITH_RANGE = Schema.memberBuilder("numberWithRange", PreludeSchemas.INTEGER)
        .id(ID)
        .traits(
    ...
    private static final Schema SCHEMA_XML_NAMESPACED = Schema.memberBuilder("xmlNamespaced", PreludeSchemas.STRING)
        .id(ID)
        .traits(
    ...
    static final Schema SCHEMA = Schema.builder()
        ...
        .members(
            ...
            SCHEMA_STRING_WITH_LENGTH,
            SCHEMA_NUMBER_WITH_RANGE,
            SCHEMA_XML_NAMESPACED
        )
        .build();
