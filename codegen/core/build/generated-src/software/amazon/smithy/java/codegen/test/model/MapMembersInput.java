...
public final class MapMembersInput implements SerializableStruct {
    ...
    static final Schema SCHEMA = Schema.structureBuilder(ID)
        .putMember("requiredMap", SharedSchemas.MAP_STRING_STRING,
            new RequiredTrait())
        .putMember("optionalMap", SharedSchemas.MAP_STRING_STRING)
        .putMember("defaultMap", SharedSchemas.MAP_STRING_STRING,
            new DefaultTrait(Node.objectNodeBuilder()
                .build()))
        .build();

    private static final Schema SCHEMA_REQUIRED_MAP = SCHEMA.member("requiredMap");
    private static final Schema SCHEMA_OPTIONAL_MAP = SCHEMA.member("optionalMap");
    private static final Schema SCHEMA_DEFAULT_MAP = SCHEMA.member("defaultMap");
    ...
    private MapMembersInput(Builder builder) {
        ...
        this.optionalMap = builder.optionalMap == null ? null : Collections.unmodifiableMap(builder.optionalMap);
