 ...
 */
public record JMESPathDocumentVisitor(Document document) implements ExpressionVisitor<Document> {
    ...
    public Document visitSubexpression(Subexpression subexpression) {
        ...
        return subexpression.getRight().accept(new JMESPathDocumentVisitor(left));
    }
}
