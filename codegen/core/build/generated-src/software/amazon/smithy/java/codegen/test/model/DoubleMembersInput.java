...
public final class DoubleMembersInput implements SerializableStruct {
    ...
    static final Schema SCHEMA = Schema.structureBuilder(ID)
        .putMember("requiredDouble", PreludeSchemas.DOUBLE,
            new RequiredTrait())
        .putMember("optionalDouble", PreludeSchemas.DOUBLE)
        .putMember("defaultDouble", PreludeSchemas.DOUBLE,
            new DefaultTrait(Node.from(1.0)))
        .build();

    private static final Schema SCHEMA_REQUIRED_DOUBLE = SCHEMA.member("requiredDouble");
    private static final Schema SCHEMA_OPTIONAL_DOUBLE = SCHEMA.member("optionalDouble");
    private static final Schema SCHEMA_DEFAULT_DOUBLE = SCHEMA.member("defaultDouble");
