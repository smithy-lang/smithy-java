...
public final class SimpleException extends ModeledSdkException {
   ...
   private static final InnerSerializer INNER_SERIALIZER = new InnerSerializer();
    ...
    private static final class InnerSerializer implements BiConsumer<SimpleException, ShapeSerializer> {
        @Override
        public void accept(SimpleException shape, ShapeSerializer serializer) {
