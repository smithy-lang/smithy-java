...
public final class DefaultsInput implements SerializableStruct {
    ...
    static final Schema SCHEMA = Schema.structureBuilder(ID)
        .putMember("boolean", PreludeSchemas.BOOLEAN,
            new DefaultTrait(Node.from(true)))
        ...
        .putMember("blob", PreludeSchemas.BLOB,
            new DefaultTrait(Node.from("YmxvYg==")))
        .putMember("streamingBlob", SharedSchemas.STREAMING_BLOB,
            new DefaultTrait(Node.from("c3RyZWFtaW5n")))
        .putMember("boolDoc", PreludeSchemas.DOCUMENT,
            new DefaultTrait(Node.from(true)))
        .putMember("stringDoc", PreludeSchemas.DOCUMENT,
            new DefaultTrait(Node.from("string")))
        .putMember("numberDoc", PreludeSchemas.DOCUMENT,
            new DefaultTrait(Node.from(1)))
        .putMember("floatingPointnumberDoc", PreludeSchemas.DOCUMENT,
            new DefaultTrait(Node.from(1.2)))
        .putMember("listDoc", PreludeSchemas.DOCUMENT,
            new DefaultTrait(ArrayNode.builder()
                .build()))
        .putMember("mapDoc", PreludeSchemas.DOCUMENT,
            new DefaultTrait(Node.objectNodeBuilder()
                .build()))
