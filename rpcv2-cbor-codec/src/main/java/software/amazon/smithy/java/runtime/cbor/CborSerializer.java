...
final class CborSerializer implements ShapeSerializer {
    ...
    public CborSerializer(OutputStream os) {
        this.sink = new Sink.OutputStreamSink(os);
    }

    public CborSerializer() {
        this.sink = new Sink.ResizingSink();
    }
    ...
    public void writeTimestamp(Schema schema, Instant value) {
        long epochSeconds = value.toEpochMilli();
        sink.write(TYPE_TAG | TAG_TIME_EPOCH);
        write8Nonnegative(epochSeconds);
    }
