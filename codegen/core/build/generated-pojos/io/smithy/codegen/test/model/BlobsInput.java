...
@SmithyGenerated
public final class BlobsInput implements SerializableShape {
    ...
    static final class InnerSerializer implements BiConsumer<BlobsInput, ShapeSerializer> {
        static final InnerSerializer INSTANCE = new InnerSerializer();

        @Override
        public void accept(BlobsInput shape, ShapeSerializer serializer) {
            serializer.writeBlob(SCHEMA_REQUIRED_BLOB, shape.requiredBlob);
            if (shape.optionalBlob != null) {
                serializer.writeBlob(SCHEMA_OPTIONAL_BLOB, shape.optionalBlob);
            }
        }
    }
