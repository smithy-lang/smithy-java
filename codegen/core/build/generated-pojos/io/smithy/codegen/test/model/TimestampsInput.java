...
@SmithyGenerated
public final class TimestampsInput implements SerializableShape {
    ...
    static final class InnerSerializer implements BiConsumer<TimestampsInput, ShapeSerializer> {
        static final InnerSerializer INSTANCE = new InnerSerializer();

        @Override
        public void accept(TimestampsInput shape, ShapeSerializer serializer) {
            serializer.writeTimestamp(SCHEMA_REQUIRED_TIMESTAMP, shape.requiredTimestamp);
            if (shape.optionalTimestamp != null) {
                serializer.writeTimestamp(SCHEMA_OPTIONAL_TIMESTAMP, shape.optionalTimestamp);
            }
            serializer.writeTimestamp(SCHEMA_DEFAULT_TIMESTAMP, shape.defaultTimestamp);
        }
    }
