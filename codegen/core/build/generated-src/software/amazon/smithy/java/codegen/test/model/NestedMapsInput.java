...
public final class NestedMapsInput implements SerializableStruct {
    public static final ShapeId ID = ShapeId.from("smithy.java.codegen.test.maps#NestedMapsInput");

    static final Schema SCHEMA = Schema.structureBuilder(ID)
        .putMember("mapOfStringMap", SharedSchemas.MAP_OF_STRING_MAP)
        .putMember("mapOfMapOfStringMap", SharedSchemas.MAP_OF_MAP_OF_STRING_MAP)
        .putMember("mapOfStringList", SharedSchemas.MAP_OF_STRING_LIST)
        .putMember("mapOfMapList", SharedSchemas.MAP_OF_MAP_LIST)
        .build();

    private static final Schema SCHEMA_MAP_OF_STRING_MAP = SCHEMA.member("mapOfStringMap");
    private static final Schema SCHEMA_MAP_OF_MAP_OF_STRING_MAP = SCHEMA.member("mapOfMapOfStringMap");
    private static final Schema SCHEMA_MAP_OF_STRING_LIST = SCHEMA.member("mapOfStringList");
    private static final Schema SCHEMA_MAP_OF_MAP_LIST = SCHEMA.member("mapOfMapList");
    ...
    private NestedMapsInput(Builder builder) {
        this.mapOfStringMap = builder.mapOfStringMap == null ? null : Collections.unmodifiableMap(builder.mapOfStringMap);
        this.mapOfMapOfStringMap = builder.mapOfMapOfStringMap == null ? null : Collections.unmodifiableMap(builder.mapOfMapOfStringMap);
        this.mapOfStringList = builder.mapOfStringList == null ? null : Collections.unmodifiableMap(builder.mapOfStringList);
        this.mapOfMapList = builder.mapOfMapList == null ? null : Collections.unmodifiableMap(builder.mapOfMapList);
    }
    ...
    public boolean equals(Object other) {
        ...
        return Objects.equals(this.mapOfStringMap, that.mapOfStringMap)
               && Objects.equals(this.mapOfMapOfStringMap, that.mapOfMapOfStringMap)
               && Objects.equals(this.mapOfStringList, that.mapOfStringList)
               && Objects.equals(this.mapOfMapList, that.mapOfMapList);
    }
     ...
     */
    public static final class Builder implements ShapeBuilder<NestedMapsInput> {
