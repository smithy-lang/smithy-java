 ...
 *
 * <p>This resolver delegates to {@link InetAddress#getAllByName(String)}, which
 * typically uses the operating system's DNS resolution. The JVM maintains its own
 * DNS cache with configurable TTLs via security properties:
 * <ul>
 ...
 * </ul>
 *
 * <p>This resolver is stateless and does not perform any caching beyond what the
 * JVM provides. It returns all addresses from DNS resolution, preserving the order
 * returned by the underlying resolver.
 *
 * <p>Thread-safe and suitable for use as a singleton.
 */
