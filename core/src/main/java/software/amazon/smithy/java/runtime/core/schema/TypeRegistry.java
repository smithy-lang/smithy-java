...
public final class TypeRegistry {
     ...
     * @return the optionally created builder.
     * @param <T> Shape type.
     * @throws SerdeException if the given type isn't compatible with the shape in the registry.
     */
    ...
    public <T extends SerializableShape> Optional<ShapeBuilder<T>> create(ShapeId shapeId, Class<T> type) {
        ...
        if (mapping == null) {
            ...
            throw new SerdeException("Polymorphic shape " + shapeId + " is not compatible with " + type);
        }
    }
