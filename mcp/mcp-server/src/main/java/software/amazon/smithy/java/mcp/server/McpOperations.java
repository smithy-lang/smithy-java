...
public interface McpOperations {
    ...
    default McpOutcome complete(McpCall.Complete call, McpRequestContext context) {
        throw new UnsupportedOperationException("completion/complete is not implemented");
    }

    default McpOutcome setLogLevel(McpCall.SetLogLevel call, McpRequestContext context) {
