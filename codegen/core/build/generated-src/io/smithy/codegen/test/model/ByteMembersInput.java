...
public final class ByteMembersInput implements SerializableStruct {
    ...
    private static final Schema SCHEMA_REQUIRED_BYTE = Schema.memberBuilder("requiredByte", PreludeSchemas.BYTE)
        .id(ID)
        .traits(
            new RequiredTrait()
        )
    ...
    private static final Schema SCHEMA_OPTIONAL_BYTE = Schema.memberBuilder("optionalByte", PreludeSchemas.BYTE)
        .id(ID)
        .build();

    private static final Schema SCHEMA_DEFAULT_BYTE = Schema.memberBuilder("defaultByte", PreludeSchemas.BYTE)
        .id(ID)
        .traits(
