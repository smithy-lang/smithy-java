...
public final class DocumentMembersInput implements SerializableStruct {
    ...
    private static final Schema SCHEMA_REQUIRED_DOC = Schema.memberBuilder("requiredDoc", PreludeSchemas.DOCUMENT)
        .id(ID)
        .traits(
            new RequiredTrait()
        )
    ...
    private static final Schema SCHEMA_OPTIONAL_DOCUMENT = Schema.memberBuilder("optionalDocument", PreludeSchemas.DOCUMENT)
        .id(ID)
        .build();
