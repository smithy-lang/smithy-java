...
public final class NestedListsInput implements SerializableStruct {
    ...
    private static final Schema SCHEMA_LIST_OF_LISTS = Schema.memberBuilder("listOfLists", SharedSchemas.LIST_OF_STRING_LIST)
        .id(ID)
        .build();

    private static final Schema SCHEMA_LIST_OF_LIST_OF_LIST = Schema.memberBuilder("listOfListOfList", SharedSchemas.LIST_OF_LIST_OF_STRING_LIST)
        .id(ID)
        .build();

    private static final Schema SCHEMA_LIST_OF_MAPS = Schema.memberBuilder("listOfMaps", SharedSchemas.LIST_OF_MAPS)
        .id(ID)
        .build();
