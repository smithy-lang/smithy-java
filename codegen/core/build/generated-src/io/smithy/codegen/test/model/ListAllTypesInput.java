...
public final class ListAllTypesInput implements SerializableStruct {
    ...
    private static final Schema SCHEMA_LIST_OF_BOOLEAN = Schema.memberBuilder("listOfBoolean", SharedSchemas.BOOLEANS)
        .id(ID)
        .build();

    private static final Schema SCHEMA_LIST_OF_BIG_DECIMAL = Schema.memberBuilder("listOfBigDecimal", SharedSchemas.BIG_DECIMALS)
        .id(ID)
        .build();

    private static final Schema SCHEMA_LIST_OF_BIG_INTEGER = Schema.memberBuilder("listOfBigInteger", SharedSchemas.BIG_INTEGERS)
        .id(ID)
        .build();

    private static final Schema SCHEMA_LIST_OF_BYTE = Schema.memberBuilder("listOfByte", SharedSchemas.BYTES)
        .id(ID)
        .build();

    private static final Schema SCHEMA_LIST_OF_DOUBLE = Schema.memberBuilder("listOfDouble", SharedSchemas.DOUBLES)
        .id(ID)
        .build();

    private static final Schema SCHEMA_LIST_OF_FLOAT = Schema.memberBuilder("listOfFloat", SharedSchemas.FLOATS)
        .id(ID)
        .build();

    private static final Schema SCHEMA_LIST_OF_INTEGER = Schema.memberBuilder("listOfInteger", SharedSchemas.INTEGERS)
        .id(ID)
        .build();

    private static final Schema SCHEMA_LIST_OF_LONG = Schema.memberBuilder("listOfLong", SharedSchemas.LONGS)
        .id(ID)
        .build();

    private static final Schema SCHEMA_LIST_OF_SHORT = Schema.memberBuilder("listOfShort", SharedSchemas.SHORTS)
        .id(ID)
        .build();

    private static final Schema SCHEMA_LIST_OF_STRING = Schema.memberBuilder("listOfString", SharedSchemas.LIST_OF_STRING)
        .id(ID)
        .build();

    private static final Schema SCHEMA_LIST_OF_BLOBS = Schema.memberBuilder("listOfBlobs", SharedSchemas.BLOBS)
        .id(ID)
        .build();

    private static final Schema SCHEMA_LIST_OF_TIMESTAMPS = Schema.memberBuilder("listOfTimestamps", SharedSchemas.TIMESTAMPS)
        .id(ID)
        .build();

    private static final Schema SCHEMA_LIST_OF_UNION = Schema.memberBuilder("listOfUnion", SharedSchemas.UNIONS)
        .id(ID)
        .build();

    private static final Schema SCHEMA_LIST_OF_ENUM = Schema.memberBuilder("listOfEnum", SharedSchemas.ENUMS)
        .id(ID)
        .build();

    private static final Schema SCHEMA_LIST_OF_INT_ENUM = Schema.memberBuilder("listOfIntEnum", SharedSchemas.INT_ENUMS)
        .id(ID)
        .build();

    private static final Schema SCHEMA_LIST_OF_STRUCT = Schema.memberBuilder("listOfStruct", SharedSchemas.STRUCTS)
        .id(ID)
        .build();

    private static final Schema SCHEMA_LIST_OF_DOCUMENTS = Schema.memberBuilder("listOfDocuments", SharedSchemas.DOCS)
        .id(ID)
        .build();
    ...
    private ListAllTypesInput(Builder builder) {
        this.listOfBoolean = builder.listOfBoolean;
        this.listOfBigDecimal = builder.listOfBigDecimal;
        this.listOfBigInteger = builder.listOfBigInteger;
        this.listOfByte = builder.listOfByte;
        this.listOfDouble = builder.listOfDouble;
        this.listOfFloat = builder.listOfFloat;
        this.listOfInteger = builder.listOfInteger;
        this.listOfLong = builder.listOfLong;
        this.listOfShort = builder.listOfShort;
        this.listOfString = builder.listOfString;
        this.listOfBlobs = builder.listOfBlobs;
        this.listOfTimestamps = builder.listOfTimestamps;
        this.listOfUnion = builder.listOfUnion;
        this.listOfEnum = builder.listOfEnum;
        this.listOfIntEnum = builder.listOfIntEnum;
        this.listOfStruct = builder.listOfStruct;
        this.listOfDocuments = builder.listOfDocuments;
    }
    ...
    public List<Boolean> listOfBoolean() {
        ...
        return Collections.unmodifiableList(listOfBoolean);
    }
    ...
    public List<BigDecimal> listOfBigDecimal() {
        ...
        return Collections.unmodifiableList(listOfBigDecimal);
    }
    ...
    public List<BigInteger> listOfBigInteger() {
        ...
        return Collections.unmodifiableList(listOfBigInteger);
    }
    ...
    public List<Byte> listOfByte() {
        ...
        return Collections.unmodifiableList(listOfByte);
    }
    ...
    public List<Double> listOfDouble() {
        ...
        return Collections.unmodifiableList(listOfDouble);
    }
    ...
    public List<Float> listOfFloat() {
        ...
        return Collections.unmodifiableList(listOfFloat);
    }
    ...
    public List<Integer> listOfInteger() {
        ...
        return Collections.unmodifiableList(listOfInteger);
    }
    ...
    public List<Long> listOfLong() {
        ...
        return Collections.unmodifiableList(listOfLong);
    }
    ...
    public List<Short> listOfShort() {
        ...
        return Collections.unmodifiableList(listOfShort);
    }
    ...
    public List<String> listOfString() {
        ...
        return Collections.unmodifiableList(listOfString);
    }
    ...
    public List<byte[]> listOfBlobs() {
        ...
        return Collections.unmodifiableList(listOfBlobs);
    }
    ...
    public List<Instant> listOfTimestamps() {
        ...
        return Collections.unmodifiableList(listOfTimestamps);
    }
    ...
    public List<NestedUnion> listOfUnion() {
        ...
        return Collections.unmodifiableList(listOfUnion);
    }
    ...
    public List<NestedEnum> listOfEnum() {
        ...
        return Collections.unmodifiableList(listOfEnum);
    }
    ...
    public List<NestedIntEnum> listOfIntEnum() {
        ...
        return Collections.unmodifiableList(listOfIntEnum);
    }
    ...
    public List<NestedStruct> listOfStruct() {
        ...
        return Collections.unmodifiableList(listOfStruct);
    }
    ...
    public List<Document> listOfDocuments() {
        ...
        return Collections.unmodifiableList(listOfDocuments);
    }
