        ...
        public Builder deserialize(ShapeDeserializer decoder) {
            decoder.readStruct(SCHEMA, (member, de) -> {
                switch (member.memberIndex()) {
                    ...
                    case 5 -> list(SharedSchemas.deserializeListOfString(member, de));
                    case 6 -> set(SharedSchemas.deserializeSetOfString(member, de));
                    case 7 -> requiredList(SharedSchemas.deserializeListOfString(member, de));
