...
public enum HttpVersionPolicy {
     ...
     *
     * <p>Per RFC 9113 Section 3.3, the client sends HTTP/2 frames directly without
     * upgrade negotiation. For TLS connections, this behaves like ENFORCE_HTTP_2.
     */
    H2C_PRIOR_KNOWLEDGE;
    ...
    public String[] alpnProtocols() {
        return switch (this) {
            case ENFORCE_HTTP_1_1 -> new String[] {"http/1.1"};
            case ENFORCE_HTTP_2, H2C_PRIOR_KNOWLEDGE -> new String[] {"h2"};
            case AUTOMATIC -> new String[] {"h2", "http/1.1"};
        };
    }
