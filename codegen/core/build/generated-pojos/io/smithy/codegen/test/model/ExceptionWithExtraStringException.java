...
public final class ExceptionWithExtraStringException extends ModeledSdkException {
   ...
   private static final InnerSerializer INNER_SERIALIZER = new InnerSerializer();
    ...
    private static final class InnerSerializer implements BiConsumer<ExceptionWithExtraStringException, ShapeSerializer> {
        @Override
        public void accept(ExceptionWithExtraStringException shape, ShapeSerializer serializer) {
            serializer.writeString(SCHEMA_MESSAGE, shape.getMessage());
            if (shape.extra != null) {
                serializer.writeString(SCHEMA_EXTRA, shape.extra);
            }
        }
    }
