...
public final class IntegerMembersInput implements SerializableStruct {
    ...
    static final Schema SCHEMA = Schema.structureBuilder(ID)
        .putMember("requiredInt", PreludeSchemas.INTEGER,
            new RequiredTrait())
        .putMember("optionalInt", PreludeSchemas.INTEGER)
        .putMember("defaultInt", PreludeSchemas.INTEGER,
            new DefaultTrait(Node.from(1)))
        .build();

    private static final Schema SCHEMA_REQUIRED_INT = SCHEMA.member("requiredInt");
    private static final Schema SCHEMA_OPTIONAL_INT = SCHEMA.member("optionalInt");
    private static final Schema SCHEMA_DEFAULT_INT = SCHEMA.member("defaultInt");
