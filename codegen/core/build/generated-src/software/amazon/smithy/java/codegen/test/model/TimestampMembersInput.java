...
@SmithyGenerated
public final class TimestampMembersInput implements SerializableStruct {
    public static final ShapeId ID = ShapeId.from("smithy.java.codegen.test.structures#TimestampMembersInput");

    static final Schema SCHEMA = Schema.structureBuilder(ID)
        .putMember("requiredTimestamp", PreludeSchemas.TIMESTAMP,
            new RequiredTrait())
        .putMember("optionalTimestamp", PreludeSchemas.TIMESTAMP)
        .putMember("defaultTimestamp", PreludeSchemas.TIMESTAMP,
            new DefaultTrait(Node.from("1985-04-12T23:20:50.52Z")))
        .build();

    private static final Schema SCHEMA_REQUIRED_TIMESTAMP = SCHEMA.member("requiredTimestamp");
    private static final Schema SCHEMA_OPTIONAL_TIMESTAMP = SCHEMA.member("optionalTimestamp");
    private static final Schema SCHEMA_DEFAULT_TIMESTAMP = SCHEMA.member("defaultTimestamp");
    ...
    private TimestampMembersInput(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        TimestampMembersInput that = (TimestampMembersInput) other;
        return Objects.equals(this.requiredTimestamp, that.requiredTimestamp)
               && Objects.equals(this.optionalTimestamp, that.optionalTimestamp)
               && Objects.equals(this.defaultTimestamp, that.defaultTimestamp);
    }
    ...
    /**
     * Builder for {@link TimestampMembersInput}.
     */
    public static final class Builder implements ShapeBuilder<TimestampMembersInput> {
        ...
        @Override
        public TimestampMembersInput build() {
            tracker.validate();
            return new TimestampMembersInput(this);
        }

        @Override
        public ShapeBuilder<TimestampMembersInput> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
