...
public final class FloatMembersInput implements SerializableStruct {
    ...
    static final Schema SCHEMA = Schema.structureBuilder(ID)
        .putMember("requiredFloat", PreludeSchemas.FLOAT,
            new RequiredTrait())
        .putMember("optionalFloat", PreludeSchemas.FLOAT)
        .putMember("defaultFloat", PreludeSchemas.FLOAT,
            new DefaultTrait(Node.from(1.0)))
        .build();

    private static final Schema SCHEMA_REQUIRED_FLOAT = SCHEMA.member("requiredFloat");
    private static final Schema SCHEMA_OPTIONAL_FLOAT = SCHEMA.member("optionalFloat");
    private static final Schema SCHEMA_DEFAULT_FLOAT = SCHEMA.member("defaultFloat");
