...
public final class BooleanMembersInput implements SerializableStruct {
    ...
    static final Schema SCHEMA = Schema.structureBuilder(ID)
        .putMember("requiredBoolean", PreludeSchemas.BOOLEAN,
            new RequiredTrait())
        .putMember("defaultBoolean", PreludeSchemas.BOOLEAN,
            new DefaultTrait(Node.from(true)))
        .putMember("optionalBoolean", PreludeSchemas.BOOLEAN)
        .build();

    private static final Schema SCHEMA_REQUIRED_BOOLEAN = SCHEMA.member("requiredBoolean");
    private static final Schema SCHEMA_DEFAULT_BOOLEAN = SCHEMA.member("defaultBoolean");
    private static final Schema SCHEMA_OPTIONAL_BOOLEAN = SCHEMA.member("optionalBoolean");
