...
public class ProxyService implements Service {
    ...
    private ProxyService(Builder builder, ServiceShape service, Model model) {
        ...
        this.dynamicClient = DynamicClient.builder()
                .service(service.getId())
                .model(model)
                .addIdentityResolver(builder.identityResolver)
                .endpointResolver(params -> CompletableFuture.completedFuture(Endpoint.builder()
                        .uri("https://" + builder.proxyEndpoint)
                        .build()))
                .putSupportedAuthSchemes(builder.authScheme)
                .putConfig(RegionSetting.REGION, builder.region)
                .build();
    ...
    private static final class DynamicFunction implements BiFunction<WrappedDocument, RequestContext, WrappedDocument> {
