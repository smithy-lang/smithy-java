...
public final class StringMembersInput implements SerializableStruct {
    ...
    private static final Schema SCHEMA_REQUIRED_STRING = Schema.memberBuilder("requiredString", PreludeSchemas.STRING)
        .id(ID)
        .traits(
            new RequiredTrait()
        )
    ...
    private static final Schema SCHEMA_DEFAULT_STRING = Schema.memberBuilder("defaultString", PreludeSchemas.STRING)
        .id(ID)
        .traits(
    ...
    private static final Schema SCHEMA_OPTIONAL_STRING = Schema.memberBuilder("optionalString", PreludeSchemas.STRING)
        .id(ID)
        .build();
