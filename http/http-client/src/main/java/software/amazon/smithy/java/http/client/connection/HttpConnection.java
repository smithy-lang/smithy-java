...
public interface HttpConnection extends AutoCloseable {
     ...
     *
     * <p>This is a fast check suitable for frequent calls. For connections
     * retrieved from a pool after being idle, use {@link #validateForReuse()}
     ...
     *
     * <p>This is more expensive than {@link #isActive()} but catches
     * connections that were closed by the server while idle in the pool.
     * Should be called when retrieving a connection that has been idle.
     *
     * <p>Default implementation just calls {@link #isActive()}.
     *
