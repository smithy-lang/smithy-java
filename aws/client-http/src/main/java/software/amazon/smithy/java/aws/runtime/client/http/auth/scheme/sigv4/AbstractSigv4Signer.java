 ...
 */
abstract class AbstractSigv4Signer {
    ...
    private static final String[] ENCODED_CHARACTERS_WITH_SLASHES_REPLACEMENTS = new String[]{
        "%20",
        "%2A",
        "~",
        "/",
    ...
    private static final String[] ENCODED_CHARACTERS_WITHOUT_SLASHES_REPLACEMENTS = new String[]{
        "%20",
        "%2A",
        "~",
        "%"};

    protected static byte[] getCanonicalRequest(
        String method,
        URI uri,
        ...
        StringBuilder builder = new StringBuilder(256)
            ...
            .append("\n")
            .append(payloadHash);
        LOGGER.trace("AWS SigV4 Canonical Request: '{}'", builder.toString());
    ...
    protected static byte[] deriveSigningKey(
        ...
        if (signingKey != null && signingKey.isValidForDate(instant)) {
    ...
    // TODO: Should this go in a common package?
