...
public class RulesEngineTest {
    ...
    public void canProvideFunctionsWhenLoadingRules() {
        ...
        engine.addExtension(new RulesEngineExtension() {
            @Override
            public List<VmFunction> getFunctions() {
                return List.of(
                        new VmFunction() {
                            @Override
        ...
        var e = Assertions.assertThrows(RulesEvaluationError.class, () -> program.run(Context.create(), Map.of()));
